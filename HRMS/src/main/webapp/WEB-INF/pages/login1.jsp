...
window.setTimeout(function() {
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="http://keenthemes.com/preview/metronic/theme/admin_3/index.html" method="post">
            <% 	
...
//             	String error = "Invalid Credentials";
			 ...
			 %>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Enter Username" name="username" required="required"/> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Enter Password" name="password" required="required"/> </div>
            ...
            <form class="forget-form" action="" method="post">
                ...
                <div class="form-group">
                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Enter Email-ID" name="email" required/> </div>
                <div class="form-actions">
