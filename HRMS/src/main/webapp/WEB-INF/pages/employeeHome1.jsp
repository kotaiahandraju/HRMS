                    ...
                    <div class="col-md-12">
                    		...
                    		<!-- Add Employee Form Starts Here -->
                                <div class="tab-pane active" id="departmentTab">
			                        <!-- BEGIN FORM-->
			                        <form:form action="userAddEmployee.htm"   commandName="packCmd" method="post" id="addForm1" class="form-horizontal" role="form">
			                           <div class="row">
			                           <h5>Basic Info</h5>
			                           </div>
			                    ...
			                    <div class="row">
			                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			                       <table id="experience_table" class="table table-responsive">
									...
									<tr >
										<td valign="top">
											<input name="pprevComp" id="pprevComp" placeholder='Enter Previous Company Name' class="form-control" type="text" onkeydown="removeBorder(this.id);" value=""/>
<%-- 									        <form:input path="prevComp" tabindex="5" placeholder="Enter company name" class="form-control  onlyCharacters" /> --%>
										</td>
										<td valign="top">
											<input name="pprevJob" id="pprevJob" placeholder='Enter Job Title' class="form-control" type="text"  value=""/>
<%-- 								          <form:input path="prevJob" tabindex="5" placeholder="Enter job title" class="form-control  onlyCharacters" /> --%>
										</td>
										<td valign="top">
											<input name="pprevFromDate" id='pprevFromDate' placeholder='Enter From Date' type="text" class="form-control dtPick"/>
<%-- 										<form:input path="prevFromDate" tabindex="5" placeholder="Enter date" class="form-control  onlyCharacters" />  --%>
										</td>
										<td valign="top"> 
											<input name="pprevToDate" id="pprevToDate" placeholder='Enter To Date' type="text" class="form-control dtPick"/>
<%-- 									<form:input path="prevToDate" tabindex="5" placeholder="Enter date" class="form-control  onlyCharacters" />  --%>
										</td>
										<td>
											<textarea name="pprevJobDesc" id="pprevJobDesc" placeholder='Job Description' class="form-control" rows="4" cols="10"></textarea>
<%-- 								          <form:textarea path="prevJobDesc" rows="4" cols="10"/> --%>
				...
				<thead>
					...
					<tr>
						<td valign="top">
							<input name="school_name" id="school_name" placeholder='Enter School Name'  type="text" class="form-control"  onkeydown="removeBorder(this.id);" value=""/>
						</td>
						<td valign="top">
							<input name="qualification" id="qualification"  placeholder='Enter Qualification' type="text" class="form-control" value=""/>
						</td>
						<td valign="top">
							<input name="qualified_in" id="qualified_in"  placeholder='Enter Qualified_in' type="text" class="form-control" value=""/>
						</td>
						<td valign="top">
						<input name="sch_completion_date" id="sch_completion_date"  placeholder='Enter Date'  class="form-control dtPick" type="text"  value=""/>
<%-- 							<form:input path="doc" tabindex="5" placeholder="Enter date" class="form-control  onlyCharacters" /> --%>
						</td>
						<td>
							<textarea name="add_notes" id="add_notes"  placeholder='Enter Add Notes' class="form-control" rows="4" cols="10"></textarea>
<%-- 							<form:textarea path="additionalNotes" rows="4" cols="10"/> --%>
						</td>
						<td>
							<textarea name="interests" id="interests" placeholder='Enter Interests'  class="form-control" rows="4" cols="10"></textarea>
             ...
             <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<thead>
					...
					<tr>
						<td valign="top">
							<input name="dependent_name" id="dependent_name"  placeholder='Enter Dependent Name'  type="text" class="form-control" onkeydown="removeBorder(this.id);"  value=""/>
<%-- 							<form:input path="dependentName"  placeholder="Enter name" class="form-control  onlyCharacters" /> --%>
						</td>
						<td>
							<select name="dependent_relation" id="dependent_relation"  class="form-control" onchange="removeBorder(this.id);">
...
<%-- 							</form:select> --%>
						...
						<td valign="top">
							<input name="dependent_dob" id="dependent_dob" placeholder='Enter Dependent Date '  type="text" class="form-control dtPick" onkeydown="removeBorder(this.id);"/>
										...
										<div class="col-md-offset-4 col-md-8">
			                            	<div class="form-group">
			                                	<div class="col-md-offset-2 col-md-8">
			                                    	<input type="button" class="btn btn-success" value="Add Employee" id="submit1" />
...
<script type="text/javascript" src="js/employeehome1.js"></script>
...
function dtPickerOpen(){
	...
	var array = $.makeArray($('tbody tr[id]').map(function() {
	 ...
	 for(var i=0;i<array.length;i++){
		...
		$('#' + array[i] + 'pprevToDate').datepicker({
	        dateFormat: "dd-MM-yy",
	        changeDate : true,
			changeMonth : true,
			changeYear : true,
